...
def addPJs():
    ...
    documentService.displayFileName(False,False)
     ...
     # CREATION DU FORMULAIRE D'AJOUT D'UNE PIECE JOINTE
    form = SQLFORM(db.piece_jointe)
   
    form.vars.id_dossier = request.vars.idDossier
    
    # si le file_uid n'est pas vide et qu'il contient un attribue filename, on va le compléter dans le formulaire
    ...
    if form.process().accepted:
       response.flash = 'form accepted'
        # PUIS ON REDIRIGE VERS LA PAGE DE GESTION DES PIECES JOINTES
