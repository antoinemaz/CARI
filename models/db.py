...
# Ajout de l'entité et du group (role) dans la table user de web2py
...
# suppression de la possible de s'inscrire dans l'application
auth.settings.actions_disabled.append('register')

# redirection apres l'action de connexion, de modification du profil et du changement de mot de passe
...
# sujet et contenu du mail en cas de reset de mot de passe
